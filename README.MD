...
## 🚀 Booting the Kernel
```bash
qemu-system-i386 -cdrom krnl.iso -serial stdio -vga std
```
...
```
--- 
The following script will run this kernel in debug mode, so you may need to:
- run gdb
